...
<link href="http://mytharcher.github.com/feed.xml" rel="alternate" title="{{ site.title }}" type="application/atom+xml" />
...
<side>
	<h2><a href="/">{{ site.title }}</a><a href="/feed.xml" class="feed-link" title="RSS订阅"><img src="http://blog.rexsong.com/wp-content/themes/rexsong/icon_feed.gif" alt="RSS feed" /></a></h2>
	...
	<div class="block block-fork">
		<a href="https://github.com/lxyhust"><img style="position: absolute; top: 0; right: 0; border: 0;" src="https://s3.amazonaws.com/github/ribbons/forkme_right_orange_ff7600.png" alt="Fork me on GitHub"></a>
	</div>
